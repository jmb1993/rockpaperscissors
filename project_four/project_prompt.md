...
**You’ve come a long way, and it's time to show it.** You will be taking the next three weeks to build your application portfolio.**

You will be tasked with building two CRUD applications. One Ruby on Rails application, one MEAN stack application, your personal website and your final application.

On all the applications **You get to call the shots and invent your own ideas**, for your final application you will be choosing a framework & tools that are appropriate for what you want to build. Pull from everything you've learned so far, and **tackle something that'll push you a little outside of your comfort zone.**
...
* **Display your conceptual knowledge of CRUD using Rails and Postgresql.**
* **Look presentable**

##MEAN application
Your app must:

* **Display your conceptual knowledge of CRUD using a NoSQL DB**
* **Look presentable**

##Personal website

* **Be the page you would like to show off to your potential employees**
